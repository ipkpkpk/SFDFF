exp_configuration = {
    401: {
        ...
        'source_model_names': ['resnet50_l2_eps0_1'],
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               'DenseNet121', 'mobilenet_v2', 'inception_resnet_v2',
                               'inception_v4_timm', 'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
    ...
    403: {
        ...
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               'DenseNet121', 'mobilenet_v2', 'inception_resnet_v2',
                                'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
    ...
    578: {
        ...
        'source_model_names': ['ResNet50'],
        'target_model_names': ['vgg16','ResNet18', 'ResNet50',  'DenseNet121','xception','mobilenet_v2','efficientnet_b0','inception_resnet_v2','inception_v3',
                               'inception_v4_timm',  'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
        'attack_methods': {'SFDFF-RDI-TI-MI': 'CRTM'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
    ...
    579: {
        ...
        'source_model_names': ['resnet50_l2_eps0_1'],
        'target_model_names': ['xception', 'efficientnet_b0','inception_resnet_v2','inception_v3','inception_v4_timm','vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
    ...
    580: {
        ...
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               ...
                               'inception_v4_timm', 'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
        'attack_methods': {'SFDFF-ODI-TI-MI': 'COTM'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
    ...
    598: {
        ...
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               ...
                               'inception_v4_timm', 'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
        # 'resnet18_l2_eps0_1','resnet18_l2_eps0_1',
        'attack_methods': {'SFDFF-Admix-RDI-TI-MI': 'CIRTM'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
        ...
        # 'None': Without shuffle, 'SelfShuffle': Shuffle unconditionally, 'NonSelfShuffle': Shuffle to always set different index
        'blending_mode_feature': 'M',  # 'M': Convex interpolation, 'A': Addition
        ...
        'channelwise': True,
        'mixup_layer': 'conv_linear_include_last',
        # mix ratio is sampled from [mix_lower_bound_feature, mix_upper_bound_feature]
        #####################################
        'comment': ''
    },
    603: {
    ...
    923: {
        ...
        'source_model_names': ['resnet50'],
        #
        'target_model_names': ['vgg16_bn', 'resnet18', 'resnet50',  'inception_v3', 'densenet121',
                               'ens3_res20_baseline', 'ens3_res20_adp', 'ens3_res20_gal', 'ens3_res20_dverge'],
        #
        'attack_methods': {'SFDFF-RDI-TI-MI': 'CRTM'},
        'number_of_v_samples': 5,
    ...
    1406: {
        ...
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               ...
                               'inception_v4_timm', 'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
        'attack_methods': {'Admix-SFDFF-RDI-TI-MI-SI': 'CIRTMS'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
        ...
        'mixup_layer': 'conv_linear_include_last',
        #####################################
        'comment': 'Admix-SFDFF-RDI-TI-MI-SI'
    },
    ...
    1408: {
        ...
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               ...
                               'inception_v4_timm', 'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
        'attack_methods': {'SFDFF-RDI-TI-MI-SI': 'CRTMS'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
    ...
    1409: {
        ...
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               ...
                               'inception_v4_timm', 'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
        'attack_methods': {'SFDFF-RDI-TI-MI-VT': 'CRTMV'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
    ...
    1505: {
        ...
        'target_model_names': ['vgg16_bn', 'resnet18', 'resnet50', 'mobilenet_v2', 'inception_v3', 'densenet121',
                               'ens3_res20_baseline', 'ens3_res20_adp', 'ens3_res20_gal', 'ens3_res20_dverge'],
        #
        'attack_methods': {'SI-SFDFF-RDI-TI-MI': 'CRTMS'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
    ...
    1506: {
        ...
        'target_model_names': ['vgg16_bn', 'resnet18', 'resnet50', 'mobilenet_v2', 'inception_v3', 'densenet121',
                               'ens3_res20_baseline', 'ens3_res20_adp', 'ens3_res20_gal', 'ens3_res20_dverge'],
        #
        'attack_methods': {'VT-SFDFF-RDI-TI-MI': 'CRTMV'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
    ...
    701: {
        ...
        'target_model_names': ['vgg16_bn', 'resnet18', 'resnet50', 'mobilenet_v2', 'inception_v3', 'densenet121',
                               'ens3_res20_baseline', 'ens3_res20_adp', 'ens3_res20_gal', 'ens3_res20_dverge'],
        #
        'attack_methods': {'SFDFF-TI-MI': 'CTM'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
    ...
    704: {
        ...
        'mixup_layer': 'conv_linear_include_last',
        #####################################
        'comment': 'SFDFF-RDI Main Result - BS40'
    },
    705: {
        'dataset': 'ImageNet',
        'targeted': True,
        ...
        'mixup_layer': 'conv_linear_include_last',
        #####################################
        'comment': 'SFDFF-RDI Main Result - BS30'
    },
    706: {
        'dataset': 'ImageNet',
        'targeted': True,
        ...
        'mixup_layer': 'conv_linear_include_last',
        #####################################
        'comment': 'SFDFF-RDI Main Result - BS10'
    },
    707: {
        'dataset': 'ImageNet',
        'targeted': True,
        ...
        'mixup_layer': 'conv_linear_include_last',
        #####################################
        'comment': 'SFDFF-RDI Main Result - BS5'
    },
    708: {
        'dataset': 'ImageNet',
        'targeted': True,
        ...
        'target_model_names': ['ResNet18', 'ResNet50', 'vgg16', 'inception_v3', 'efficientnet_b0',
                               ...
                               'inception_v4_timm', 'xception', 'resnet50_l2_eps0_1', 'vit_base_patch16_224',
                               'levit_384', 'convit_base', 'twins_svt_base', 'pit'],
        'attack_methods': {'SFDFF-RDI-TI-NI': 'CRTN'},
        'number_of_v_samples': 5,
        'number_of_si_scales': 5,
        'visualize': False,
        ####################################
